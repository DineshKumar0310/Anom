...
const JobCard = ({ job }) => {
    ...
    const isClosingSoon = job.isActive && new Date(job.lastDate) < new Date(new Date().getTime() + 3 * 24 * 60 * 60 * 1000);
            ...
            <div className="job-card-content">
                ...
                <div className="job-card-info">
                    <div className="job-card-header">
                        ...
                        {isClosingSoon && (
                            <span className="badge badge-danger job-closing-badge">Closing Soon</span>
                        )}
                    </div>
